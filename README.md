...
Este projeto é um _fork_ do trabalho original de L4G: https://github.com/L4GSP1KE/Upload-Assistant
...
- Gera e faz upload de screenshots (capturas de tela). Suporta _tonemapping_ HDR se configurado.
- Utiliza o srrdb para corrigir nomes de _scenes_ usados nos sites.
...
- Adiciona ao seu cliente com _fast resume_, semeando instantaneamente (rtorrent/qbittorrent/deluge/pasta de monitoramento).
